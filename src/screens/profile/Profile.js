...
class Profile extends Component {
    ...
    /** Get user details from instagram graph endpoint */
    getUserName = () => {
    ...
    /** Get data from instagram graph endpoint */
    getImageDetails = () => {
        let that = this;
        fetch(
    ...
    /** open respective image modal when clicked on any image */
    ...
    /** Method to update 'Comment' state */
